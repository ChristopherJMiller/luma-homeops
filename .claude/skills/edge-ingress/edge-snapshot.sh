...
set -u
hosts="$(printf '%s\n' chrismiller.xyz www.chrismiller.xyz ci attic auth home lidarr plex prowlarr radarr sabnzbd share sonarr mediadav music dav.music lagrange dashboard rccl-tracker wordarena realliance.net www.realliance.net legacy.realliance.net)"
for h in $hosts; do
